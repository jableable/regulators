...
![MA_Path_plot_initial](./Assets/MA_path_plot_initial.png "MA Path Plot (initial)")

![MA_initial_placebo_test](./Assets/MA_initial_placebo_test.png "MA Placebo Test (initial)")
